...
class SettingsAdapter(private val listener: CharacterItemListener) : RecyclerView.Adapter<CharacterViewHolder>() {
...
class CharacterViewHolder(private val itemBinding: ItemCharacterBinding, private val listener: SettingsAdapter.CharacterItemListener) : RecyclerView.ViewHolder(itemBinding.root),
