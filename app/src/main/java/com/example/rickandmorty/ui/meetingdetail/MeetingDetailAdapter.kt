...
class MeetingDetailAdapter(private val listener: CharacterItemListener) : RecyclerView.Adapter<CharacterViewHolder>() {
...
class CharacterViewHolder(private val itemBinding: ItemCharacterBinding, private val listener: MeetingDetailAdapter.CharacterItemListener) : RecyclerView.ViewHolder(itemBinding.root),
